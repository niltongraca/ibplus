  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        <Link href="/gestao/compras" className="p-2 hover:bg-gray-100 rounded-lg">
          <ArrowLeft className="w-5 h-5 text-ib-muted" />
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-ib-primary">Nova Compra</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl">
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-ib-primary mb-1">Fornecedor</label>
              <input
                type="text"
                value={form.supplier}
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Save className="w-4 h-4" /> {saving ? "A guardar..." : "Finalizar Compra"}
          </button>
          <Link
            href="/gestao/compras"
