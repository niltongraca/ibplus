    ...
    <div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mt-4 mb-3 text-[var(--text-primary)]">Sobre o IBPlus+</h1>
        ...
        <div className="card p-8 mb-8">
          <h2 className="page-title mb-4">O que é o IBPlus+?</h2>
        ...
        <div className="card p-8 mb-8">
          <h2 className="page-title mb-6">Tipos de Conta</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {accountTypes.map((at) => (
              <div key={at.name} className="card p-4">
        ...
        <div className="card p-8 mb-8">
          <h2 className="page-title mb-4">Funcionalidades Principais</h2>
        ...
        <div className="card p-8 text-center">
          <h2 className="page-title mb-3">Tecnologia</h2>
          ...
          <div className="flex justify-center gap-4">
            <Link href="/cadastro" className="btn btn-primary inline-flex items-center gap-2 px-6 py-2.5 text-sm">
              Criar Conta Grátis
            </Link>
            <Link href="/praca" className="btn btn-secondary inline-flex items-center gap-2 px-6 py-2.5 text-sm" style={{ color: "var(--text-primary)" }}>
              Explorar a Praça
            </Link>
          </div>
        </div>
