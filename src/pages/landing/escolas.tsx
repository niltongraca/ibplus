...
export default function LandingEscolas() {
  return (
    <SiteLayout>
      <SEO title="Sistema para Escolas" description="Gestão académica e administrativa para escolas." />
      <section className="py-20 bg-gradient-to-br from-ib-primary via-ib-primary to-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-ib-accent/20 text-ib-light text-sm mb-6">
            <GraduationCap className="h-4 w-4" /> Solução IBPlus
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold mb-6">Sistema para Escolas</h1>
          <p className="text-xl text-ib-muted max-w-2xl mx-auto mb-8">Gestão académica e administrativa para escolas e centros de formação.</p>
