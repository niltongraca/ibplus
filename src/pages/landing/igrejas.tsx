...
export default function LandingIgrejas() {
  return (
    <SiteLayout>
      <SEO title="Sistema para Igrejas" description="Gestão de membros, dízimos e ofertas." />
      <section className="py-20 bg-gradient-to-br from-ib-primary via-ib-primary to-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-ib-accent/20 text-ib-light text-sm mb-6">
            <Church className="h-4 w-4" /> Solução IBPlus
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold mb-6">Sistema para Igrejas</h1>
          <p className="text-xl text-ib-muted max-w-2xl mx-auto mb-8">Gestão de membros, dízimos, ofertas e eventos da sua igreja.</p>
