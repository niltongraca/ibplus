...
export default function LandingLojaOnline() {
  return (
    <SiteLayout>
      <SEO title="Loja Online" description="Venda 24/7 com a sua loja virtual integrada." />
      <section className="py-20 bg-gradient-to-br from-ib-primary via-ib-primary to-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-ib-accent/20 text-ib-light text-sm mb-6">
            <ShoppingBag className="h-4 w-4" /> Módulo IBPlus
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold mb-6">Loja Online</h1>
          <p className="text-xl text-ib-muted max-w-2xl mx-auto mb-8">Venda 24/7 com a sua loja virtual integrada ao sistema de gestão.</p>
